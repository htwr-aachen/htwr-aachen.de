...
> **Eingabe:** $n$ Gegenstände $(I)$ jedes mit Gewicht $w_i \in \underline{W}$ und Wert $v_i$ $(i \in \underline{n})$ und ein maximales Gewicht $W$
>
...
> **Eingabe:** Formel $\phi$ in KNF (Konjunktiver Normalform, also $(x_1 \lor x_2) \land (x_3 \lor x_4)$)
>
...
> **Eingabe:** Formel $\phi$ in KNF, aber mit nur drei Variablen pro und verknüpfun (Konjunktiver Normalform, also $(x_1 \lor x_2 \lor \overline{x_3}) \land (x_1 \lor x_2 \lor x_3)$)
>
> **Frage:** gibt es eine erfüllende Belegung für $\phi$?
