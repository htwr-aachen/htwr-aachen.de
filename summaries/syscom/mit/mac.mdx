...
Wenn der Receiver eine Transmission erhält, sendet er auf z.B. einem anderen Channel ein Busy Tone, welches jeder in Reichweite dann checkt. Das ist _Receiver initiated BTMA_ klappt natürlich erst wenn der Empfänger verstanden hat, dass er der Empfänger ist.

Bei _Busy Tone Multiple Access_ (BTMA) senden alle die gerade etwas empfangen den Busy Tone nicht nur der eigentlich Empfänger. Beides zusammen geht auch aka _Wireless Collision Detect_
