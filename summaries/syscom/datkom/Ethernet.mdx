...
![WLAN-Kabel](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExNGl4bWd6cHQzN3hvcTJoaTBwc3Q3em9mb2pqb3Jlanp0eHI5NWptNCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/5aY2MOdRZ2y8kQfIHH/giphy.gif)
$\uparrow$
...
Hierfür kommt zuerst das PAD-Feld, welches auch unteranderem das Frame padded bis es minimal 64 Byte hat. Hier ist natürlich wichtig das z.b. Bit-Stuffing verwendet wird, damit man das PAD-Feld erkennen kann.

  (PSSS: Bit-Stuffing war das mit dem erstem von dem Pattern(z.b. 0111 =>
  01101) und dem Rückwandeln danach

Und dann gibt es noch das Frame-Check-Sequence[FCS](CRC Check) also eine Prüfsumme mit [Cyclic-Redundancy-Check](https://de.wikipedia.org/wiki/Zyklische_Redundanzpr%C3%BCfung)
