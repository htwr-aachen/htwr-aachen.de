...
- **4B/5B:** Hier wird differentielle NRZ verwendet aber man bildet je 4Bit Eingabe auf 5Bit Übertragung ab, somit behält man eine gute Effizienz und Selbsttaktung
