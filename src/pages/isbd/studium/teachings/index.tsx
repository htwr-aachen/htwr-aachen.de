...
export const TeachingsDirectory = join(DefaultTeachingDir, "isbd", "dbis");
...
export const getStaticProps: GetStaticProps = async () => {
  const folien = getAllDocsFromDir(
    join(process.cwd(), "public", "teaching-assets", "isbd", "dbis", "folien"),
    "/teaching-assets/isbd/dbis/folien",
    true
  );
...
const Teachings: FC<TeachingsProps> = ({ docs, folien }) => {
  return (
    <Main
      meta={
        <Meta
          title="Zusammenfassungen - ISBD@HTWR"
          ...
          <div className="">
            ...
            <ul className="my-2 ml-8 list-disc">
              <li>
                <a
                  target={"_blank"}
                  href="/teaching-assets/isbd/dbis/folien-merged.pdf"
                >
                  Folienmerge
                </a>
              </li>
              <li>
                ...
                <a
                  target={"_blank"}
                  href="/teaching-assets/isbd/dbis/panikzettel.pdf"
                >
                  hier.
                </a>
                )
