---
title: Manchester - Wer will nach Manchester (Coderungsarten)
...
![Eine Übersicht der simplen Coderungsarten](/teaching-assets/syscom/simple-codes.png)

und es gibt Biphase-codes, die eine **Selbsttaktung**, wo die Clocks snychronisiert werden können, ermöglichen:

![Eine Übersicht der Biphase-coderungsarten](/teaching-assets/syscom/biphase-codes.png)
...
<Spoiler>
Naja wenn man das geübt hat, geht das wie alles andere auch. Wendet einfach immer wieder das Schema an und verwecheslt die einzelnen Subklassen nicht.
</Spoiler>
...
<Spoiler>
Wie oben $1000$ baud mit NRZ ist $1000$ Bit/s, mit Manchester $500$ Bit/s und mit Biphase $500$ Bit/s.
</Spoiler>

x> Gegeben ein Signalbild, welche Modulation wurde verwendet?

<Spoiler>
Dann muss man auf unterschiedliche Frequenzen, Amplituden und Phasen achten. Gegebenenfalls mehreres.
</Spoiler>
...
<Spoiler>
Wegen Abtasttheorem $40Khz$ und dann $16Bit$ quantisierung, also $40000 \cdot 16 = 640000$ Bit/s
</Spoiler>