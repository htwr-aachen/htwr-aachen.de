...
<iframe src="https://giphy.com/embed/5aY2MOdRZ2y8kQfIHH" width="480" height="270" frameBorder="0" className="giphy-embed" allowFullScreen></iframe>
$\uparrow$
...
Ethernet ist nicht umbedingt ein Standard, es wurde oft erweitert (für z.B. 100MBit/s etc) somit unterscheiden sich die Codierungen mehr dazu [hier](/teachings/machester-werwillnachmanchaster)
Die Verteilung sieht so aus:
- < 100MBit/s: [Manchaster](/teachings/machester-werwillnachmanchaster##Manchaster)
- < 1 GBit/s: [4B5B](/teachings/machester-werwillnachmanchaster##4B5B)
...
<p className="small">(PSSS: Bit-Stuffing war das mit dem ersteten von dem Pattern(z.b. 0111 => 01101) und dem Rückwandeln danach</p>
...
Eigentlich sind die meisten Aufgaben direkt für Layer 2 und [Medienzugriff](/teachings/halt-haltmaldeinefressebitte#Aufgaben) (ist deutlich wichtiger).
