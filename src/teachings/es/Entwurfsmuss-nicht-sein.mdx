...
date: 09/02/2023
order: 4
tags: [Entwurfsmuster, Adapter, Composite, Decorator, Factory, Observer, Singleton, CommandProcessor, Tips]
---
...
<div className="center">
![Composite](/teaching-assets/es/composite-muster.png)
</div>
...
<div className="center">
![Factory](/teaching-assets/es/factory-muster.png)
</div>
...
<div className="center">
![Decorator](/teaching-assets/es/decorator-muster.png)
</div>

Der Decorator ist ein Wrapper, der ein Objekt umschließt und es verändert. 
Er ist ähnlich wie der Adapter, aber der Adapter verändert die Schnittstelle, während der Decorator das Objekt verändert (Der Decorator erbt von der Abstrakten Klasse ruft dann aber sein *base* auf)
...
<div className="center">
![Observer](/teaching-assets/es/observer-muster.png)
</div>
...
<div className="center">
  ![CommandProcessor](/teaching-assets/es/command-processor-muster.png)  
</div>
