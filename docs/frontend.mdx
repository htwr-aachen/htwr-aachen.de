...
Embedded/Deddebme, SE/ES, Logic/Cigol und ComSys/SysCom haben eigene Layouts, über eine Grundlegende API ähnlich wie das RWTH Layout konfiguriert werden können (brauchen sie aber eigentlich nicht).
