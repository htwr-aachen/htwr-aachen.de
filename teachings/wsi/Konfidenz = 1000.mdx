...
Gilt mit $c > 0$: $\frac{T}{c} \sim \chi^2(k)$ oder $T \sim c \cdot \chi^2(k)$, dann ist heißt $T$ gestreckte $\chi^2$-verteilt.
...
Ein Konfidenzintervall grenzt einen Parameter statistisch ein. Das Konfidenzniveau gibt an wie sicher man sich seien kann, dass der wahre Parameter innerhalb des Konfidenzintervalls liegt.
