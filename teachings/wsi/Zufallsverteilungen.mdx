...
Ihr müsst diese ganzen Sachen überhaupt nicht auswendig könne. Ihr müsst nur wissen, dass sie existieren.
...
- **Gleichverteilung**
  $X \sim U(a,b)$ <br/>
  $f_X(x) = \begin{cases} \frac{1}{b-a}, & a < x < b \\ 0, & sonst \end{cases}$
...
- **Exponentialverteilung**
  ...
  Verteilungsfunktion: $F_X(x) = \begin{cases} 1 - e^{-\lambda x}, & x \ge 0 \\ 0, & sonst \end{cases}$
...
- **Normalverteilung**
  ...
  Wichtiges zu beachten: <br/>
    ...
    - Bei der Normalverteilung ließt man meistens Werte von einer Tabelle ab. Da ihr sicher nicht diese Formel mit dem Ubuntu Taschenrechner ausrechnen wollt.
