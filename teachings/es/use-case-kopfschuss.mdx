...
- **Erweiterung**: Falls ein Use-Case Zusatzwünsche bietet: Z.B. Ein Use Case Pizza backen mit _extension point_ Belag: hat gestrichelte Pfeile (!anders herum reingehend in den Pizza backen Use-Case) mit einem Pfeilkopf und `<<extend>>` drauf.
