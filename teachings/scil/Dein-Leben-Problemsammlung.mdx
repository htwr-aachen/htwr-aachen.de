...
- Eingabe TM _M_, Wort _w_. Frage: Schreibt _M_ auf der Eingabe w jemals ein Nicht-Blanksymbol auf das Band? | Tutorium 03
...
- $L_{17} = $ \{ $\langle M \rangle \mid$ _M_ berechnet bei Eingabe der Zahl 17 die Zahl 42} | VO
...
Alle semi-entscheidbaren Probleme (Eigentlich sind _fast_ alle unentscheidbaren Probleme semi-entscheidbar !Außer allgemeine Halteproblem und $A_{all}$!):
